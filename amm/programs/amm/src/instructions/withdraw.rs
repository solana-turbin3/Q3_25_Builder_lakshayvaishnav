...
use crate::{error::AmmError, program::Amm, Config};
...
impl<'info> Withdraw<'info> {
    pub fn withdraw(
        &mut self,
        amount: u64, // Amount of LP tokens that user wants to burn
        ...
        require!(self.config.locked == false, AmmError::InvalidConfig);
